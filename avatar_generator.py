...
class avatar_generator:
	...
	def str2meta(self, string):
		...
		if eval('0x' + md5str[-20]) % 4 == 0:
			...
			symmetry_method = 'y_axial_symmetry'
		...
		if symmetry_method == 'quad_centrosymmetry':
			for i in range(0, 4):
	...
	def meta_generator(self, avatarInfo, x_len = 400, y_len = 400, block_len = 50):
		meta = ''
		if avatarInfo['symmetry_method'] == 'quad_centrosymmetry':
		...
		elif avatarInfo['symmetry_method'] == 'y_axial_symmetry':
	...
	def avatar_generator(self, meta):
		...
		elif meta['sym_info'] == 'y_axial_symmetry':
			avatar = self.y_axial_symmetry(meta['meta'])
